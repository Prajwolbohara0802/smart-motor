...
void loop(){
 ...
 int xvalue;
  xvalue=analogRead(A7);
  int read=map(xvalue,328,349,0,9);
  Serial.println("accelerometer=");
  Serial.println(xvalue);
 delay(100);
      
tft.fillRect(10, 80, map(xvalue,0,1023,0,300), 20, BLACKM);

  delay(1000);

tft.fillRect(10, 80, map(xvalue,0,1023,0,300), 20, WHITE);
