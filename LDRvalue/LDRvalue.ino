...
void loop(){
 ...
 int ldrvalue;
  ldrvalue=analogRead(A6);
  int read=map(ldrvalue,0,1023,0,9);
  Serial.println("ldr value=");
  Serial.println(ldrvalue);
 delay(100);
      
tft.fillRect(10, 80, map(ldrvalue,0,1023,0,300), 20, BLACKM);

  delay(1000);

tft.fillRect(10, 80, map(ldrvalue,0,1023,0,300), 20, WHITE);
